...
def predict_emotion(image_path):
    ...
    print(pre_label)
    pre_label = np.argmax(pre_label[0], 1)
    print(pre_label)
    label_name = {
        0: 'Neutral',
        1: 'Happy',
...
if __name__ == '__main__':
    startTime = time.time()
    result = predict_emotion("test_image/test.jpg")
    endTime = time.time()
