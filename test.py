...
# train_path = '/media/zsl/D/xjw/MNI/resnet18/save_train_path.txt'
# val_path = '/media/zsl/D/yjy/code/PycharmRemoteServerTestPro/baseline1/txt/sfew2/val_rgb/val.txt'
# val_path = '/media/D/znx/MNI/resnet18/image/mm.txt'
val_path = '/media/D/xjw/MNI/resnet18/CAER-S/test_crop.txt'
# val_path = '/media/zsl/D/xjw/MNI/resnet18/FER_val/FER_private_test.txt'
# val_path = '/media/zsl/D/xjw/MNI/resnet18/FER_val/FER_public_test.txt'
# val_path = '/media/zsl/D/xjw/MNI/resnet18/RAF/RAF_test.txt'
# val_path = '/media/zsl/D/xjw/MNI/resnet18/SFEW-val/SFEW_test.txt'
# 创建一个解析器
...
with tf.Session()as sess:
    ...
    # restorer.restore(sess, '/media/zsl/D/xjw/MNI/resnet18/models/uncut_pic_models/epoch62')
    restorer.restore(sess, '/media/D/znx/MNI/resnet18/pretrain_model/epoch24')
    # restorer.restore(sess, '/media/zsl/D/xjw/MNI/resnet18/RAF_DB_part_model/epoch26')
    # restorer.restore(sess, '/media/zsl/D/xjw/MNI/resnet18/pretrain_model/epoch24')
    # restorer.restore(sess, '/media/zsl/D/xjw/MNI/resnet18/models_0/epoch3')
    ...
    # for epoch in range(1, val_batch + 1):
